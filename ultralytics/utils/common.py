...
def rotate_image(im, polys=None, angle=0):
    """
...
def mask_to_bboxes(masks, scores, image_shape=None, labels=[]):
    ...
    if len(labels) > 0:
        return bboxes, valid_scores, valid_labels
    else:
        return bboxes, valid_scores, None
